...
The majority of the code above has been well explained in my [PySNMP HLAPI]({% post_url 2022-01-11-pysnmp-hlapi-overview %}) post and are very similar to that of the getCmd() command. The two differences are:
